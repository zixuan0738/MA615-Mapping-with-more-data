...
![image1](https://raw.githubusercontent.com/zixuan0738/MA615---Mapping-Assignment/main/mapping.png)
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/zixuan0738/MA615---Mapping-Assignment/blob/main/sample.png?raw=true",  dpi = NULL)
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/zixuan0738/MA615---Mapping-Assignment/blob/main/pa1.png?raw=true",  dpi = NULL)
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/zixuan0738/MA615---Mapping-Assignment/blob/main/projectNumber.png?raw=true",  dpi = NULL)
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/zixuan0738/MA615---Mapping-Assignment/blob/main/federalShare.png?raw=true",  dpi = NULL)
```
